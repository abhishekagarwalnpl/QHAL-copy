...
INT_MINUS_PI_BY_2 = angle_to_integer(-PI/2)
#
...
int_theta = angle_to_integer(theta)
int_minus_theta = angle_to_integer(-theta)
...
for i in range(lattice_sites):
    ...
    q_index,status,readout = measurement_unpacker(hal.accept_command(command_creator("QUBIT_MEASURE", 0, 1))) 
